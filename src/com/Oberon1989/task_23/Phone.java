...
//region getters
    ...
    public String toString() {
        return String.format("ID: %s, Марка: %s, Модель: %s, Количество ядер: %s, Диагоаль экрана: %s, Вес: %s грамм, Цвет: %s, Цена: %s рублей",ID,brand,model,cpuCoreCont,screenDiagonal,weight,color,price);
    }
...
class compareBrand implements Comparator<Phone>
{
    @Override
...
class compareModel implements Comparator<Phone>
{
    @Override
    public int compare(Phone o1, Phone o2) {
...
class compareCountCpu implements Comparator<Phone>
{
    @Override
    public int compare(Phone o1, Phone o2) {
...
class compareScreenDiagonal implements Comparator<Phone>
{
    @Override
    public int compare(Phone o1, Phone o2) {
...
class compareWeight implements Comparator<Phone>
{
    @Override
    public int compare(Phone o1, Phone o2) {
...
class compareColor implements Comparator<Phone>
{
    @Override
    public int compare(Phone o1, Phone o2) {
...
class comparePrice implements Comparator<Phone>
{
    @Override
    public int compare(Phone o1, Phone o2) {
